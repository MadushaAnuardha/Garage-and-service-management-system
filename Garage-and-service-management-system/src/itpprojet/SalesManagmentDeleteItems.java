/*
 * SalesManagmentDeleteItems.java
 *
 * Created on 23 August 2017, 15:20
 */
 ...
 * @author  Ravindu DD
 */
public class SalesManagmentDeleteItems extends javax.swing.JFrame {
    Connection con = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /** Creates new form SalesManagmentDeleteItems */
    public SalesManagmentDeleteItems() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Seles Managment Delete Items");
...
// TODO add your handling code here:
        try {
          ...
          String s5 = ("DELETE FROM product where id = '"+jTextField1.getText()+"'");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SalesManagmentDeleteItems().setVisible(true);
            }
        });
    }
