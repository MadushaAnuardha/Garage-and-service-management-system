/*
 * EmployeeUpdateDeatails.java
 *
 * Created on 25 August 2017, 08:41
 */
 ...
 * @author  Ravindu DD
 */
public class EmployeeUpdateDeatails extends javax.swing.JFrame {
    Connection con = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    /** Creates new form EmployeeUpdateDeatails */
    public EmployeeUpdateDeatails() {
        initComponents();
    }
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(jTextField6, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)))
                .addGap(775, 775, 775))
        );
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 2000, 640));
...
// TODO add your handling code here:
        ...
        String sql = (" SELECT * FROM employee WHERE id = '"+jTextField8.getText()+"' ");
        ...
        jTextField5.setText(rs.getString("telephone"));
        jTextField6.setText(rs.getString("age"));
        jTextField7.setText(rs.getString("accountNo"));
        jComboBox1.setSelectedItem(rs.getString("jobeRole"));    
...
// TODO add your handling code here:
       ...
       String s2 = ("UPDATE employee SET address='"+jTextField3.getText()+"',jobeRole='"+jComboBox1.getSelectedItem()+"',,accountNo='"+jTextField7.getText()+"'telephone='"+jTextField5.getText()+"' WHERE id='"+jTextField1.getText()+"'");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeUpdateDeatails().setVisible(true);
            }
        });
    }
